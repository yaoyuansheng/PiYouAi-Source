                ...
                },
                {
                ...
                },
                  {
                      ...
                      formatter: function (value, row, index) {
                          var c = " <a href='../InfoBanner/delete?id=" + row.id + "'>删除</a>";
                          var a = " <a href='../InfoBanner/Edit?id=" + row.id + "'>编辑</a>";
                          return  a+ c;
...
$(function () {
    ...
    $update.click(function () {
        if (confirm('确认需要修改用户信息吗？')) {
            ...
            if (ids != '') {
                window.location.href = "/InfoBanner/Edit?id=" + ids;
            }
            else {
                alert("请先勾选数据在操作哦");
            }
    ...
    $add.click(function () {
        ...
        window.location.href = "/InfoBanner/Create";
