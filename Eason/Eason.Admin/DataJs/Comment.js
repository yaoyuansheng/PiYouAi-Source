...
$(function () {
    ...
    //        });
    //        if (ids != '') {
    //            window.location.href = "/Comment/Edit?id=" + ids;
    //        }
    //        else {
    //            alert("请先勾选数据在操作哦");
    //        }
    ...
    //    //});
    //    //if (ids != '') {
    //    window.location.href = "/Comment/Create";
    //    //}
    //    //else {
    //    //    alert("请先勾选数据在操作哦");
    //    //}
    ...
    $btn_no_active.click(function () {
        if (confirm('确定审核不通过？不通过的评论无法在前端展示？')) {
            var items = $table.bootstrapTable('getAllSelections');
            //alert(JSON.stringify(items));
            var ids = '';
            $.each(items, function (index, data) {
