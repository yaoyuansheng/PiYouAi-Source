                ...
                },
                {
                ...
                },
                  {
                      ...
                      formatter: function (value, row, index) {
                          var c = " <a href='../IndexBanner/delete?id=" + row.id + "'>删除</a>";
                          var a = " <a href='../IndexBanner/Edit?id=" + row.id + "'>编辑</a>";
                          return  a+ c;
...
$(function () {
    ...
    $update.click(function () {
        if (confirm('确认需要修改用户信息吗？')) {
            ...
            if (ids != '') {
                window.location.href = "/IndexBanner/Edit?id=" + ids;
            }
            else {
                alert("请先勾选数据在操作哦");
            }
    ...
    $add.click(function () {
        ...
        window.location.href = "/IndexBanner/Create";
