...
{
    //[Authorize]
    //public class TypesController : EBaseController
    //{
    //    const string admin = "Administrots";
    //    public TypesController()
    //    {
    //        easonRepository = new EasonRepository<ArticleType, long>();
    //    }
    //    private EasonRepository<ArticleType, long> easonRepository;
    //    // GET: Category
    ...
    //        var newList = new List<ArticleType>();
    ...
    //    private List<ArticleType> GetChild(long parentId, IList<ArticleType> oldList, List<ArticleType> NewList)
    //    {
