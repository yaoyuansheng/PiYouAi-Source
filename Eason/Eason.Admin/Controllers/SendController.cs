...
namespace Eason.Admin.Controllers
{
    ...
    public class SendController : EBaseController
    {
        ...
        public ActionResult List(int offset, int limit, string search)
        {
            ...
            IQueryable<ShortMessage> articles;
            ...
            {
                articles = repository.GetAllList(offset, limit, m => m.telephone.Contains(search));
            }
        ...
        public ActionResult Create(ShortMessage user)
        {
            if (user != null)
            {
