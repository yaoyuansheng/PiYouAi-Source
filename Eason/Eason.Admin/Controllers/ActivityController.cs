...
namespace Eason.Admin.Controllers
{
    ...
    public class ActivityController : EBaseController
    {
        ...
        {
            repository = new EasonRepository<Forward, long>();
        }
        ...
        public ActionResult List(int offset, int limit, string search)
        {
            ...
            {
                articles = repository.GetAllList(offset, limit, m => m.hdname.Contains(search));
            }
        ...
        public ActionResult Create(Forward user)
        {
            if (user != null)
            {
