...
{
    [Authorize]
    public class IndexBannerController : EBaseController
    {
        public IndexBannerController()
        {
            repository = new EasonRepository<IndexBanner, long>();
        }
        private EasonRepository<IndexBanner, long> repository;
        // GET: IndexBanner
        ...
        public ActionResult List(int offset, int limit, string search)
        {
            ...
            IQueryable<IndexBanner> articles;
        ...
        public ActionResult Create(IndexBanner user)
        {
            if (user != null)
            {
